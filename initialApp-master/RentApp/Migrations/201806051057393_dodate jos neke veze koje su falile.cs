namespace RentApp.Migrations
{
    ...
    public partial class dodatejosnekevezekojesufalile : DbMigration
    {
        public override void Up()
        {
            AddColumn("dbo.Branches", "ServiceId", c => c.Int(nullable: false));
        ...
        public override void Down()
        {
            ...
            DropColumn("dbo.Branches", "ServiceId");
        }
    }
}
